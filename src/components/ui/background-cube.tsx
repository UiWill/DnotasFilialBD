...
import { PerspectiveCamera, Environment, ContactShadows, SpotLight, useDepthBuffer } from "@react-three/drei"
...
const RubiksCubeModel = forwardRef<any, any>((props, ref) => {
  ...
  // Material preto igual ao código original
...
export function BackgroundCube({ className }: BackgroundCubeProps) {
